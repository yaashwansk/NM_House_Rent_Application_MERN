      ...
      <>
         ...
         <div className="d-flex column mt-5">
            {filteredProperties && filteredProperties.length > 0 ? (
               ...
               <div style={{ display: 'flex', justifyContent: 'space-between', gap: '05px' }}>
                  ...
                  <div>
                     ...
                     <p><strong>Owner Name:</strong> Yaashwan</p>
                     <p><strong>Property Type:</strong> Residential</p>
                     <p><strong>Ad Type:</strong> Rent</p>
                     <p><strong>Full Address:</strong> 123 Main Street, Chennai</p>
                     <p><strong>Owner Contact:</strong> 9876543210</p>
                     <p><strong>Property Amount:</strong> Rs. 50,000</p>
                     <p><strong>Additional Info:</strong> Well-furnished, close to amenities.</p>
                  </div>
                  <div>
                     <div style={{ position: 'relative', overflow: 'hidden' }}>
                        <img 
                     ...
                     <p><strong>Owner Name:</strong> Rajesh</p>
                     <p><strong>Property Type:</strong> Residential</p>
                     <p><strong>Ad Type:</strong> Rent</p>
                     <p><strong>Full Address:</strong> No 20, Adyar, Chennai</p>
                     <p><strong>Owner Contact:</strong> 78725649787</p>
                     <p><strong>Property Amount:</strong> Rs. 60,000</p>
                     <p><strong>Additional Info:</strong> Well-furnished, close to amenities.</p>
                  </div>
                  <div>
                     <div style={{ position: 'relative', overflow: 'hidden' }}>
                     ...
                     <p><strong>Owner Name:</strong> Iliyas</p>
                     <p><strong>Property Type:</strong> Residential</p>
                     <p><strong>Ad Type:</strong> Rent</p>
                     <p><strong>Full Address:</strong> No 123, OMR, Chennai</p>
                     <p><strong>Owner Contact:</strong> 9656324587</p>
                     <p><strong>Property Amount:</strong> Rs. 40,000</p>
                     <p><strong>Additional Info:</strong> Semi-furnished, close to amenities.</p>
                  </div>
                  <div>
                     <div style={{ position: 'relative', overflow: 'hidden' }}>
                        <img 
                     ...
                     <p><strong>Owner Name:</strong> Libni Macklends</p>
                     <p><strong>Property Type:</strong> Residential</p>
                     <p><strong>Ad Type:</strong> Rent</p>
                     <p><strong>Full Address:</strong> No 453A, ECR, Chennai</p>
                     <p><strong>Owner Contact:</strong> 7845632198</p>
                     <p><strong>Property Amount:</strong> Rs. 40,000</p>
                     <p><strong>Additional Info:</strong> Semi-furnished, close to amenities.</p>
                  </div>
