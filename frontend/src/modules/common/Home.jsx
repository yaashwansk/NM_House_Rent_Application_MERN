   ...
   return (
      <>
         <Navbar expand="lg" className="bg-body-tertiary" bg='red'>
            <Container fluid>
               <Navbar.Brand><h2>RILY<h6>EasyBuy-Own-Rent</h6></h2></Navbar.Brand>
         ...
         <div className='property-content'>
            <div className='text-center'>
               ...
               <p style={{fontSize: 15, fontWeight: 800}}>Want to Own a Property? <Link to={'/Register'}><Button variant='outline-info'>Register as Tenent</Button></Link></p>
            </div>
